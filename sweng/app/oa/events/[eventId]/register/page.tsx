...
export default function RegisterPage() {
    ...
    const takeDonorImage = () => {
        alert("Donor image taken!");
    };
        ...
        <main className="flex flex-col min-h-screen bg-[#f9fdff]">
            ...
            <div className="flex-1 bg-[#f9fdff] p-[0.35in]">
                ...
                <section className="mt-[0.15in] bg-white border-2 border-[#c0cad0] rounded-[16px] p-[0.35in] shadow-sm">
                    ...
                    <form className="mt-[0.35in] grid grid-cols-1 lg:grid-cols-[2.6in_1fr] gap-[0.35in]">
                        {/* Left Column: Donor Image */}
                        <aside className="flex flex-col gap-[0.25in]">
                            <button
                                type="button"
                                onClick={takeDonorImage}
                                className="w-full min-h-[3.5in] bg-[#002940] rounded-[18px] border-2 border-[#002940] flex flex-col items-center justify-center cursor-pointer hover:opacity-95 transition"
                            >
                                ...
                                <p className="mt-5 text-[24px] font-['Montserrat'] font-bold text-white text-center">
                                    Capture Image
                                </p>
                            </button>
                            ...
                            <button
                                type="button"
                                className="w-full bg-white text-[#002940] border-2 border-[#002940] px-[20px] py-[10px] rounded-[10px] text-[18px] font-semibold cursor-pointer text-center hover:underline"
                            >
                                Upload Image
                            </button>
                        </aside>

                        {/* Right Column: Donor Form Fields */}
