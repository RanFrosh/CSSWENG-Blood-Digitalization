                    ...
                    <div className="text-[21px] flex flex-col">
                        ...
                        <div className="relative w-full">
                            <input
                                ...
                                className="w-full border-2 border-gray-300 rounded-md focus:border-[#1b4054] pl-[10px] pr-[42px] outline-none"
                            />
                            ...
                            <button
                                ...
                                className="absolute right-[10px] top-1/2 -translate-y-1/2 cursor-pointer text-[#1b4054] hover:text-[#fd5448] transition"
                            >
                                {showPassword ? (
