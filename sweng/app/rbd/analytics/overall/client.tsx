...
import { OverallAnalytics } from "./page";

interface OverallAnalyticsClientProps {
...
export default function OverallAnalyticsClient({
    analytics,
    availableCities,
    availablePartners,
    currentStartDate,
    ...
    const updateFilter = (key: string, value: string) => {
        ...
        if (value && value !== "All Cities" && value !== "All Partners") {
