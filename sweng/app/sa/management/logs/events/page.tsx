...
export default function SAOnsiteLogsPage() {
    ...
    const userOptions = [
        "All Users",
        ...Array.from(new Set(logs.map((log) => log.staff))),
    ];
    ...
    if (userFilter !== "All Users") {
        filteredLogs = filteredLogs.filter((log) => log.staff === userFilter);
    }
            ...
            <div className="flex-1 bg-[#f9fdff] p-[0.35in]">
                ...
                <section className="mt-[0.15in] bg-white border-2 border-[#c0cad0] rounded-[16px] p-[0.25in] shadow-sm">
                    ...
                    <div className="mt-[0.25in] border-2 border-[#c0cad0] rounded-[14px] p-[0.2in] bg-[#f9fdff]">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-[0.2in]">
                            <div>
