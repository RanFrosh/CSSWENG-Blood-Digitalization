...
export interface EventData {
    queryEvent(data: ViewEventFilters, sort: Sorter): Promise<ApiResponse<ViewEvents[]>>
    createEvent(data: CreateEvents): Promise<ApiResponse>

    queryCorrection(data: ViewCorrectionFilters, sort: Sorter): Promise<ApiResponse<ViewCorrections[]>>
    createCorrection(data: CreateCorrectionFilters): Promise<ApiResponse>
}

export interface EventController {
    invokeQueryEvent(data: ViewEventFilters, sort: Sorter): Promise<ApiResponse<ViewEvents[]>>
    invokeCreateEvent(data: CreateEvents): Promise<ApiResponse>

    invokeQueryCorrection(data: ViewCorrectionFilters, sort: Sorter): Promise<ApiResponse<ViewCorrections[]>>
