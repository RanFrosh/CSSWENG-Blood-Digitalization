...
const permissions = {
    ...
    'view_event': ['onsite_admin', 'med_prof', 'director', 'lab_staff', 'super_admin', 'recov_staff'] as AccessType[],
    'create_event': ['onsite_admin', 'med_prof', 'director', 'super_admin'] as AccessType[],
    'update_event': ['onsite_admin', 'med_prof', 'director'] as AccessType[],
